...
function HomeDownload() {
  return (
    <div className=" w-full relative py-20 flex items-center justify-center flex-col gap-y-16">
        <TitleDescription
        ...
        <div className="w-full flex items-center justify-center flex-col gap-y-10 px-4 ">
            <SliderBestComment />
        </div>
        <div className={"bg-bg-button-green absolute bottom-0 h-[590px] w-full"}></div>
    </div>
  )
}
