    ...
    <div className="relative w-full md:mt-16">
      ...
      >
        ...
        <div className="w-full max-w-[900px] grid grid-cols-1 px-4 min-[300px]:grid-cols-2 gap-4 md:gap-10 lg:grid-cols-3">
          <div className="bg-bg-box2 dark:bg-gray-800 dark:shadow-2xl dark:shadow-gray-800/40 transition-colors min-h-80 max-sm:!min-h-56 max-sm:h-56 px-3 pt-10 max-sm:pt-14 pb-7 rounded-3xl flex items-center justify-between max-sm:justify-center flex-col gap-8 max-sm:gap-12">
            <div className="w-full h-1/3 flex justify-center items-center">
              <ImageBoxAdvantage variant="Simplicity" />
            </div>
            <div className="w-full h-2/3 max-sm:h-auto">
              <TitleDescriptionBox
                headerClass="max-sm:!text-base !text-xl !font-Estedad-Medium dark:text-white"
                descClass="!leading-10 max-sm:text-xs max-sm:!hidden !max-w-[170px] font-Estedad-Regular"
