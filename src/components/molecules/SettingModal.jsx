  ...
  return (
    ...
    >
      <Modal.Box
        initial={{ y: "100vw" }}
        animate={{ y: 0 }}
        className="max-w-[48rem] w-full max-h-[40rem] h-full transition-colors bg-cream-light dark:bg-gray-800/70 dark:!backdrop-blur-3xl rounded-2xl flex flex-col shadow-2xl shadow-black/10 dark:shadow-gray-600/10 max-2xl:!scale-[0.7]"
      >
        ...
        <Modal.Body className="w-full h-full transition-colors bg-white dark:bg-gray-800 dark:text-white rounded-b-2xl rounded-t-3xl">
